        ...
        <div className="container mt-5">
            <div className="row">
                <div className="col-12">
                    ...
                    <p><b>RUN: </b><span onClick={copyToClipboard}>hakrawler -url {props.thisFqdn.fqdn} -depth 3 &gt; hakrawler.{props.thisFqdn.fqdn}.txt; cat hakrawler.{props.thisFqdn.fqdn}.txt | xclip -i -selection clipboard</span></p> 
                </div>
            </div>
            <div className="row">
                {
